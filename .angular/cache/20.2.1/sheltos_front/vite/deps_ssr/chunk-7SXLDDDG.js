...
var filterActions = (actions) => {
  return (0, import_rxjs.filter)((state) => actions.indexOf(state.action) > -1);
};
var GalleryRef = class {
  ...
  constructor(config, deleteInstance) {
    ...
    this.itemClick = new import_rxjs.Subject();
    this.thumbClick = new import_rxjs.Subject();
    this.error = new import_rxjs.Subject();
    this._state = new import_rxjs.BehaviorSubject(defaultState);
    this._config = new import_rxjs.BehaviorSubject(config);
   ...
   */
  activatePlayer() {
    return this.playerActions.pipe((0, import_rxjs.switchMap)((e) => e.isPlaying ? (0, import_rxjs.of)({}).pipe((0, import_rxjs.delay)(this._config.value.playerInterval), (0, import_rxjs.tap)(() => this.next(this._config.value.scrollBehavior))) : import_rxjs.EMPTY));
  }
  /**
   * Set gallery state
   */
...
var _GallerySliderComponent = class _GallerySliderComponent {
  ...
  constructor(_el, _cd, _zone, _platform, _smoothScroll, _gallery) {
    ...
    this.scrollHandler$ = new import_rxjs.Subject();
    this.visibleElements = /* @__PURE__ */ new Map();
    this._destroyed$ = new import_rxjs.Subject();
    this.itemClick = new EventEmitter();
    this.error = new EventEmitter();
    this.items = new QueryList();
    this.scrollHandler$.pipe((0, import_rxjs.debounceTime)(0, import_rxjs.animationFrameScheduler), (0, import_rxjs.switchMap)(({
      value,
      behavior
    }) => {
      ...
      if (el) {
        ...
        return (0, import_rxjs.from)(this._smoothScroll.scrollTo(this.slider, pos)).pipe((0, import_rxjs.tap)(() => {
    ...
    }), (0, import_rxjs.takeUntil)(this._destroyed$)).subscribe();
  }
  ngOnChanges(changes) {
    if (changes.config) {
  ...
  ngOnInit() {
    if (this._platform.isBrowser) {
      this._zone.runOutsideAngular(() => {
        this.createIntersectionObserver(this.slider).pipe((0, import_rxjs.tap)((entry) => {
        ...
        (0, import_rxjs.fromEvent)(this.slider, "scroll", {
          passive: true
        }).pipe((0, import_rxjs.debounceTime)(50), (0, import_rxjs.filter)(() => !this._isPanning), (0, import_rxjs.tap)(() => this.onViewportScroll()), (0, import_rxjs.takeUntil)(this._destroyed$)).subscribe();
        resizeObservable(this._el.nativeElement).pipe((0, import_rxjs.debounceTime)(this.config.resizeDebounceTime), (0, import_rxjs.tap)(([entry]) => this.onHostResize(entry)), (0, import_rxjs.takeUntil)(this._destroyed$)).subscribe();
      });
    }
  }
  ngAfterViewInit() {
    if (this._platform.isBrowser) {
      ...
      this.items.changes.pipe((0, import_rxjs.startWith)(null), (0, import_rxjs.tap)(() => {
  ...
  createIntersectionObserver(slider) {
    ...
    }).pipe((0, import_rxjs.mergeMap)((entries) => entries), (0, import_rxjs.distinctUntilChanged)());
  }
};
...
var _GalleryThumbsComponent = class _GalleryThumbsComponent {
  ...
  ngAfterViewInit() {
    if (this._platform.isBrowser) {
      ...
      this._zone.runOutsideAngular(() => {
        resizeObservable(this._el.nativeElement).pipe((0, import_rxjs.debounceTime)(this.config.resizeDebounceTime), (0, import_rxjs.tap)(() => {
...
var _GalleryComponent = class _GalleryComponent {
  constructor(_gallery) {
    ...
    this.error = new EventEmitter();
    this._itemClick$ = import_rxjs.Subscription.EMPTY;
    this._thumbClick$ = import_rxjs.Subscription.EMPTY;
    this._itemChange$ = import_rxjs.Subscription.EMPTY;
    this._indexChange$ = import_rxjs.Subscription.EMPTY;
    this._playingChange$ = import_rxjs.Subscription.EMPTY;
    this._playerListener$ = import_rxjs.Subscription.EMPTY;
  }
  getConfig() {
    return {
      nav: this.nav,
...
//# sourceMappingURL=chunk-7SXLDDDG.js.map
