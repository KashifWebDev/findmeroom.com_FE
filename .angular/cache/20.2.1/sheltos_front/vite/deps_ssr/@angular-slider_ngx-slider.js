...
function TooltipWrapperComponent_Conditional_0_0_ng_template_0_Template(rf, ctx) {
}
function TooltipWrapperComponent_Conditional_0_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TooltipWrapperComponent_Conditional_0_0_ng_template_0_Template, 0, 0, "ng-template");
  }
}
function TooltipWrapperComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TooltipWrapperComponent_Conditional_0_0_Template, 1, 0, null, 1);
  }
  if (rf & 2) {
...
function TooltipWrapperComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SliderComponent_For_29_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "ngx-slider-tooltip-wrapper", 28);
  }
  if (rf & 2) {
...
function SliderComponent_For_29_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "span", 29);
  }
  if (rf & 2) {
...
function SliderComponent_For_29_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "span", 30);
  }
  if (rf & 2) {
...
function SliderComponent_For_29_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "span", 26);
    ɵɵelement(1, "ngx-slider-tooltip-wrapper", 27);
    ɵɵconditionalCreate(2, SliderComponent_For_29_Conditional_2_Template, 1, 4, "ngx-slider-tooltip-wrapper", 28);
    ɵɵconditionalCreate(3, SliderComponent_For_29_Conditional_3_Template, 1, 1, "span", 29);
    ɵɵconditionalCreate(4, SliderComponent_For_29_Conditional_4_Template, 1, 1, "span", 30);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(t_r1.value !== null && t_r1.value !== void 0 ? 2 : -1);
    ɵɵadvance();
    ɵɵconditional(t_r1.legend !== null && t_r1.legend !== void 0 && ctx_r1.allowUnsafeHtmlInSlider === false ? 3 : -1);
    ɵɵadvance();
    ɵɵconditional(t_r1.legend !== null && t_r1.legend !== void 0 && (ctx_r1.allowUnsafeHtmlInSlider === null || ctx_r1.allowUnsafeHtmlInSlider === void 0 || ctx_r1.allowUnsafeHtmlInSlider) ? 4 : -1);
  }
}
var LabelType;
(function(LabelType2) {
...
var EventListenerHelper = class {
  ...
  attachPassiveEventListener(nativeElement, eventName, callback, throttleInterval) {
    ...
    listener.events = new import_rxjs.Subject();
    ...
    listener.eventsSubscription = listener.events.pipe(
      !ValueHelper.isNullOrUndefined(throttleInterval) ? (0, import_operators.throttleTime)(throttleInterval, void 0, {
        leading: true,
        trailing: true
...
var SliderElementDirective = class _SliderElementDirective {
  ...
  static ɵfac = function SliderElementDirective_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SliderElementDirective)();
  };
...
var SliderHandleDirective = class _SliderHandleDirective extends SliderElementDirective {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵSliderHandleDirective_BaseFactory;
    return function SliderHandleDirective_Factory(__ngFactoryType__) {
      return (ɵSliderHandleDirective_BaseFactory || (ɵSliderHandleDirective_BaseFactory = ɵɵgetInheritedFactory(_SliderHandleDirective)))(__ngFactoryType__ || _SliderHandleDirective);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var SliderLabelDirective = class _SliderLabelDirective extends SliderElementDirective {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    let ɵSliderLabelDirective_BaseFactory;
    return function SliderLabelDirective_Factory(__ngFactoryType__) {
      return (ɵSliderLabelDirective_BaseFactory || (ɵSliderLabelDirective_BaseFactory = ɵɵgetInheritedFactory(_SliderLabelDirective)))(__ngFactoryType__ || _SliderLabelDirective);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var TooltipWrapperComponent = class _TooltipWrapperComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 2,
    consts: [[1, "ngx-slider-inner-tooltip"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"]],
    template: function TooltipWrapperComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵconditionalCreate(0, TooltipWrapperComponent_Conditional_0_Template, 1, 6);
        ɵɵconditionalCreate(1, TooltipWrapperComponent_Conditional_1_Template, 2, 3, "div", 0);
      }
      if (rf & 2) {
...
var SliderComponent = class _SliderComponent {
  ...
  inputModelChangeSubject = new import_rxjs.Subject();
  ...
  outputModelChangeSubject = new import_rxjs.Subject();
  ...
  subscribeInputModelChangeSubject() {
    this.inputModelChangeSubscription = this.inputModelChangeSubject.pipe(
      (0, import_operators.distinctUntilChanged)(ModelChange.compare),
      // Hack to reset the status of the distinctUntilChanged() - if a "fake" event comes through with forceChange=true,
      // we forcefully by-pass distinctUntilChanged(), but otherwise drop the event
      (0, import_operators.filter)((modelChange) => !modelChange.forceChange && !modelChange.internalChange)
    ).subscribe((modelChange) => this.applyInputModelChange(modelChange));
  }
  subscribeOutputModelChangeSubject() {
    this.outputModelChangeSubscription = this.outputModelChangeSubject.pipe((0, import_operators.distinctUntilChanged)(ModelChange.compare)).subscribe((modelChange) => this.publishOutputModelChange(modelChange));
  }
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function SliderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵrepeaterCreate(28, SliderComponent_For_29_Template, 5, 10, "span", 26, ɵɵrepeaterTrackByIdentity);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        ɵɵadvance(6);
    ...
    dependencies: [NgClass, NgStyle, SliderElementDirective, SliderHandleDirective, SliderLabelDirective, TooltipWrapperComponent],
